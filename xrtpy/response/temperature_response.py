...
_XRT_hybrid_chianti_emiss_model = sunpy.io.special.genx.read_genx(
    _hybrid_CHIANTI_filename
)

hybrid_CHIANTI_file = {
    "logged_temperature": _XRT_hybrid_chianti_emiss_model["LOGTE"],
    "wavelength": _XRT_hybrid_chianti_emiss_model["LMBDA"],
    "corona_solar_spectra": _XRT_hybrid_chianti_emiss_model["SOLSPEC"],
    "spectra_generated_information": _XRT_hybrid_chianti_emiss_model["HEADER"]["TEXT"],
}
