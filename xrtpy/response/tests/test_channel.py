...
def test_entrancefilter_density(channel_name):
    ...
    idl_entrancefilter_density_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["EN_FILTER"]["DENS"] 
        * (u.g * u.cm ** -3)
    )
...
def test_entrancefilter_wavelength(channel_name):
    ...
    idl_entrancefilter_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["EN_FILTER"]["WAVE"][:idl_entrancefilter_array_length] 
        * u.Unit("Angstrom")
        )  
...
def test_entrancefilter_transmission(channel_name):
    ...
    idl_entrancefilter_transmission_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["EN_FILTER"]["TRANS"][:idl_entrancefilter_array_length]
    )
...
def test_mirror1_density(channel_name):
    ...
    idl_mirror_density_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR1"]["DENS"] 
        * (u.g * u.cm ** -3)
    )
...
def test_mirror1_graze_angle(channel_name):
    ...
    idl_mirror_graze_angle_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR1"]["GRAZE_ANGLE"]
        * u.deg
    )
...
def test_mirror1_reflection(channel_name):
    ...
    mirror_reflection = channel_filter.mirror_1.mirror_reflection[:mirror_number_of_length]
    ...
    idl_mirror_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR1"]["REFL"][:idl_mirror_array_length]
        * u.angstrom
    )
...
def test_mirror1_wavelength(channel_name):
    ...
    idl_mirror_array_length = int( v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR1"]["LENGTH"])
    idl_mirror_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR1"]["WAVE"][:idl_mirror_array_length]
         * u.Unit("Angstrom")
         )
...
def test_mirror2_density(channel_name):
    ...
    idl_mirror_density_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR2"]["DENS"]
        * (u.g * u.cm ** -3)
        )
...
def test_mirror2_graze_angle(channel_name):
    ...
    idl_mirror_graze_angle_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR2"]["GRAZE_ANGLE"]
        * u.deg
    )
...
def test_mirror2_reflection(channel_name):
    ...
    idl_mirror_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR2"]["REFL"][:idl_mirror_array_length]
        * u.angstrom
        )
...
def test_mirror2_wavelength(channel_name):
    ...
    idl_mirror_array_length = int(v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR2"]["LENGTH"])
    idl_mirror_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["MIRROR2"]["WAVE"][:idl_mirror_array_length]
        * u.angstrom
        )
...
def test_filter1_density(channel_name):
    ...
    idl_filter_density_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["FP_FILTER1" ]["DENS"]
        * (u.g * u.cm ** -3)
        )
...
def test_filter1_thickness(channel_name):
    ...
    idl_filter_thickness_auto = v6_genx_s[_channel_name_to_index_mapping[channel_name]]["FP_FILTER1"]["THICK"]

    assert u.allclose(filter_thickness,idl_filter_thickness_auto*u.angstrom)
...
def test_filter1_wavelength(channel_name):
    ...
    idl_filter_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["FP_FILTER1"]["WAVE"][:idl_filter_array_length]
        * u.angstrom
        )
...
def test_filter2_density(channel_name):
    ...
    IDL_filter_density_AUTO = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["FP_FILTER2"]["DENS"]
        * (u.g * u.cm ** -3)
        )
...
def test_filter2_thickness(channel_name):
    ...
    idl_filter_thickness_auto = v6_genx_s[_channel_name_to_index_mapping[channel_name]]["FP_FILTER2"]["THICK"]
...
def test_filter2_wavelength(channel_name):
    ...
    idl_filter_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["FP_FILTER2"]["WAVE"][:idl_filter_array_length]
        * u.angstrom
    )
...
def test_ccd_ev_pre_electron(channel_name):
    ...
    idl_ccd_full_well_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["CCD"]["EV_PER_EL"]
        * (u.eV / u.electron)
        )
...
def test_CCD_quantum_efficiency(channel_name):
    ...
    idl_ccd_quantum_efficiency_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["CCD"]["QE"][:idl_ccd_array_length]
    )
...
def test_channel_wavelength(channel_name):
    ...
    idl_wavelength_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["WAVE"][:idl_array_length]
        * u.angstrom
    )
...
def test_channel_transmission(channel_name):
    ...
    idl_transmission_auto = (
        v6_genx_s[_channel_name_to_index_mapping[channel_name]]["TRANS"][:idl_array_length]
        )
